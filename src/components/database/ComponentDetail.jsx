...
const STAT_ROWS = [
  { key: "dps", label: "Damage / Sec", max: 500, color: "bg-[#d4713f]" },
  { key: "range", label: "Range", max: 5000, color: "bg-[#c98a52]", unit: "m" },
  { key: "fire_rate", label: "Fire Rate", max: 10, color: "bg-[#b3663c]", decimals: 1 },
  { key: "thrust", label: "Thrust", max: 2000, color: "bg-[#b8963f]", unit: "kN" },
  { key: "shield_hp", label: "Shield Capacity", max: 5000, color: "bg-[#8c9aa3]" },
  { key: "shield_regen", label: "Shield Regen", max: 100, color: "bg-[#6f7d86]", unit: "/s" },
  { key: "cargo", label: "Cargo", max: 2000, color: "bg-[#a1786b]", unit: "m³" },
];
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        ...
        {c.hp > 0 && <StatBar label="Module HP" value={c.hp} max={3000} color="bg-[#c9a678]" />}
      </div>

...
const STAT_ROWS = [
  { key: "dps", label: "Damage / Sec", max: 500, color: "bg-[#f08a45]" },
  { key: "range", label: "Range", max: 5000, color: "bg-[#dda060]", unit: "m" },
  { key: "fire_rate", label: "Fire Rate", max: 10, color: "bg-[#c9743d]", decimals: 1 },
  { key: "thrust", label: "Thrust", max: 2000, color: "bg-[#e0b64c]", unit: "kN" },
  { key: "shield_hp", label: "Shield Capacity", max: 5000, color: "bg-[#a9bcc7]" },
  { key: "shield_regen", label: "Shield Regen", max: 100, color: "bg-[#7f929e]", unit: "/s" },
  { key: "cargo", label: "Cargo", max: 2000, color: "bg-[#cf9a86]", unit: "m³" },
];
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        ...
        {c.hp > 0 && <StatBar label="Module HP" value={c.hp} max={3000} color="bg-[#e3c08a]" />}
      </div>

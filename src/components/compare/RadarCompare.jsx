  ...
  return (
    <ResponsiveContainer width="100%" height={340}>
      <RadarChart data={data} outerRadius="72%">
        ...
        <Radar name={a?.name || "A"} dataKey="A" stroke="#ff7a1a" fill="#ff7a1a" fillOpacity={0.25} strokeWidth={2} />
        <Radar name={b?.name || "B"} dataKey="B" stroke="#2f9bff" fill="#2f9bff" fillOpacity={0.22} strokeWidth={2} strokeDasharray="5 3" />

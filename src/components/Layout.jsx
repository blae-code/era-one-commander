...
import { LayoutDashboard, Wrench, Layers, Database, ArrowLeftRight, DatabaseZap, UploadCloud } from "lucide-react";
...
const NAV = [
  ...
  { to: "/import", label: "Data Import", code: "07", icon: UploadCloud },
];
